...
void task1(void *pvParameters) {
	...
	while(1) {
		...
		// Do something
		vTaskDelay(delayMillSec/portTICK_PERIOD_MS);
		// Do something
		ESP_LOGD(pcTaskGetName(0), "Wait for Notify");
	}
	vTaskDelete(NULL);
}
...
void app_main(void)
{
	...
	// Start task
	xTaskCreate(task1, "task1", 1024*4, NULL, 2, NULL);
	xTaskCreate(task2, "task2", 1024*4, NULL, 2, NULL);
	xTaskCreate(task3, "task3", 1024*4, NULL, 2, NULL);
	xTaskCreate(task4, "task4", 1024*4, NULL, 2, NULL);
	xTaskCreate(task5, "task5", 1024*4, NULL, 2, NULL);
	xTaskCreate(task6, "task6", 1024*4, NULL, 2, NULL);
